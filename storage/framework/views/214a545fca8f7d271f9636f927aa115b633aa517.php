        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xl-3 wow bounceIn" data-wow-delay=".6s">
                    <img src="<?php echo e(asset('proyecto/images/agencia.svg')); ?>" alt="La agencia">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="hidden-md-down col-lg-4">
                    <img src="<?php echo e(asset('proyecto/images/mundo.svg')); ?>" alt="Mundo movil">
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <article class="col-md-4 wow bounceInLeft" data-wow-delay=".3s">
                    <img src="<?php echo e(asset('proyecto/images/servicio-1.svg')); ?>" alt="Servicio Desarrollo de Aplicaciones Mobiles">
                ...
                <article class="col-md-4 wow bounceInUp" data-wow-delay=".6s">
                    <img src="<?php echo e(asset('proyecto/images/servicio-2.svg')); ?>" alt="Servicio Consultoría Tecnológica">
                ...
                <article class="col-md-4 wow bounceInRight" data-wow-delay="1s">
                    <img src="<?php echo e(asset('proyecto/images/servicio-3.svg')); ?>" alt="Servicio Marketing y publicidad Movil">
